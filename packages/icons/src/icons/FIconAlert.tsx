export const FIconAlert = function () {
  return (
    <svg
    ...
    >
      <path
        d="M12.75 8C12.75 7.58579 12.4142 7.25 12 7.25C11.5858 7.25 11.25 7.58579 11.25 8V13.1145C11.4868 13.0401 11.7387 13 12 13C12.2613 13 12.5132 13.0401 12.75 13.1145V8Z"
        fill="currentColor"
      ></path>
      <path
